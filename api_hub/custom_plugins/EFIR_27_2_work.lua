...
local function sanitize_string(value)
    ...
    -- value = value:gsub('"', '\\"')
     ...
     value = value:gsub("[%z\1-\31\127]", "")  -- Remove control characters
    value = value:gsub("\\", "\\\\")         -- Escape backslashes
    value = value:gsub('"', '\\"')           -- Escape double quotes
    value = value:gsub("\r", "")             -- Remove carriage returns
    value = value:gsub("\n", " ")            -- Replace newlines with space
    value = value:gsub("\\+$", "\\\\")  -- Ensure trailing backslashes are escaped
    return value
end

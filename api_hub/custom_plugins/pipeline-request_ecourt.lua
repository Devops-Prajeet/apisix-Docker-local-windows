...
local plugin_name = "pipeline-request_ecourt"
...
function _M.access(conf, ctx)
    ...
    for _, node in ipairs(conf.nodes) do
        ...
        if last_resp ~= nil then            
            ...
            core.log.warn("decoded_body in pipeline lua---anil", core.json.encode(decoded_body['data']))

...
local plugin_name = "mobile_revoke_validate"
...
local function is_valid_phone(mobile)
    -- Remove all non-digit characters
    local digits = mobile:gsub("%D", "")
...
function _M.access(conf, ctx)
    ...
    ngx.ctx.response_bodyRequest = json.decode(req_body)
